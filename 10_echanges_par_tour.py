...
class Echange:
    def __init__(self, joueur1, joueur2, nb_echanges=10):
        ...
        for echange in self.resume:
            joueur1.historique_transaction.append(echange)
            joueur2.historique_transaction.append(echange)
...
prop_strat = [('gentil', 0.1), ('mechant', 0.1), ('aleatoire', 0.2), ('copieur', 0.4), ('trader', 0.2)]
...
for tour in range(nb_tour):    
    for paire in new_game.paires_joueurs:
        ...
        new_transaction = Echange(joueur1, joueur2, nb_echanges=10)
