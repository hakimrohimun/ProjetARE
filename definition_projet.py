...
class Strategie:
    ...
    def cooperant(self): #Coopère de plus en plus en fonction du nombre d'enemie coopérant lors des derniers échanges fait. (commence par trahir)
        pass

    
    def stratege(self): #Etablit sa stratégie en fonction des échanges précédent avec ce meme joueur (commence par cooperer)
        pass
...
def main(nb_joueurs, portefeuille, liste_strategies, nb_tours):
    new_game = Partie(nb_joueurs, portefeuille, formateStrat(liste_strategies))
    #DEBUT SIMULATION
